ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :vurls, :except => :show, :member => {:description => :get, :real_time_clicks => :get, :redirect => :get, :screenshot => :get, :title => :get}, :collection => {:random => :get, :chart_settings => :get, :image_screenshot => :get}
